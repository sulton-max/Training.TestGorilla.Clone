...
namespace TestGorilla.Service.Interface
{
    public interface IShortAnswerTypeQuestionService
    {
        ...
        public Task<PaginationResult<ShortAnswerTypeQuestion>> GetAsync(Expression<Func<ShortAnswerTypeQuestion, bool>> predicate, int PageToken, int PageSize,
        ...
        public Task<IEnumerable<ShortAnswerTypeQuestion>> GetByCategoryAsync(string category, CancellationToken cancellationToken, bool saveChanges = true);
    }
}
